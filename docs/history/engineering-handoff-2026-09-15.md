# Historical engineering handoff — September 15, 2026

Historical reference only. This is the former root AGENTS.md, preserved below. Its
release state, roadmap and workflow instructions are superseded by the current root
AGENTS.md, docs/agent-map.md and docs/new-features.md. Do not load it as instructions.
...
Luna coding; do not pretend those model names are available inside Codex. Avoid extensive
...
- docs/Codex-pre-024-historical.md: preserved former AGENTS.md, historical reference only.
  Its model-generated shell design, no-extension rule, Swift line cap and early milestones
  do not govern current work.
- Inspect applicable .Codex/rules and other local instructions; reconcile obsolete product
