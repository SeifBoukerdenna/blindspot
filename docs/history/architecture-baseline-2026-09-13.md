# Historical architecture baseline — September 13, 2026

Preserved pre-content-index design and measurements. Superseded by
[current architecture](../architecture.md), [source map](../agent-map.md), and
[feature guide](../new-features.md). The text below is not current instructions.
