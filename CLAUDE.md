...
a timer (~200ms is fine). Respect `org.nspasteboard.ConcealedType` and
`org.nspasteboard.TransientType` markers so you don't capture password manager output —
this is a real privacy obligation, not a nicety.
